...
目录、插件贡献和平台拉取边界见 [架构与分发合同](../docs/architecture.md)；
...
- `publish`: publisher CLI and package release workflow; see [publishing](../docs/development.md).
...
results. No channel implementation is included in the SDK wheel. The repository maintains plugins separately under plugins/.
